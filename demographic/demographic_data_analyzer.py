...
def calculate_demographic_data(print_data=True):
    ...
    #df.loc[(df['education'].isin(['Bachelors','Masters','Doctorate'])) & (df.salary == '>50K')]
    ...
    max_salary_countries_count = df.loc[df.salary == '>50K','native-country'].value_counts()
  
    highest_earning_country = ((max_salary_countries_count / countries_count)*100).idxmax()
    highest_earning_country_percentage = round(((max_salary_countries_count / countries_count)*100).max(),1)
